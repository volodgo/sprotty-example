...
export class EdgeCreationTool extends BaseCreationTool<TriggerEdgeCreationAction> {
  ...
  doEnable(): void {
    const mouseMovingFeedback = new FeedbackEdgeEndMovingMouseListener(
      this.anchorRegistry,
    ...
    this.toDisposeOnDisable.push(
      ...
      this.mouseTool.registerListener(
        new EdgeCreationToolMouseListener(
          this.triggerAction,
      ...
      this.registerFeedback(
        ...
        this,
        [RemoveFeedbackEdgeAction.create(), cursorFeedbackAction()]
      )
    );
  }
}
...
export class EdgeCreationToolMouseListener extends DragAwareMouseListener {
  ...
  protected canConnect(
    element: GModelElement | undefined,
    role: "source" | "target"
  ): boolean {
    if (
      !element ||
